...
export class UtilityService {
    ...
    constructor(private _restApi: RestApiService, private monDataService: MonDataService, private monConfigurationService: MonConfigurationService) { }
    ...
    getServerList(tierId) {
        let url =  this.monDataService.getserviceURL() + URL.GET_SERVER_LIST + "?topoName=" + this.monConfigurationService.getTopoName()+ "&tierId=" + `${tierId}`;
        console.log(url);
